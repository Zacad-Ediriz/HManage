...
@section('scripts')
    <script>
        ...
        const updatefn = (id) => {
            ...
            $.get(url)
                .done((data) => {
                    ...
                    updateUrl = "{{ route('patientUpdate', ':id') }}"
                    updateUrl = updateUrl.replace(':id', id)
                    $("#patientForm").attr("action", updateUrl)
        ...
        $("#exampleModal").on("hidden.bs.modal", function() {
            ...
            $("#balance").val("")
            $("#remarks").val("")
            $("#patientForm").attr("action", "{{ route('patient') }}")
        })
